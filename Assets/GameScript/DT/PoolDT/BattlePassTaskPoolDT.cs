...
public class BattlePassTaskPoolDT : BasePoolDT<long>
{
    public BattlePassTaskPoolDT(int templateId)
    {
        scoreArr = new int[11];
    ...
    public int mTemplateId
    {
        ...
        private set
        {
            ...
            {
                _iTemplateId = value;
                BattlePassTaskDT tItem = (BattlePassTaskDT)glo_Main.GetInstance().m_SC_Pool.m_BattlePassTaskSC.f_GetSC(_iTemplateId);
                if (tItem == null)
MessageBox.ASSERT("TaskDailySC Id does not exist, Id: " + _iTemplateId);
    ...
    public BattlePassTaskDT mTemplate
    {
        private set;
        get;
    }
