...
public class GainCardLimitShowPage : UIFramwork
{
    ...
    private ResourceCommonDT _cost;
    ...
    protected override void UI_OPEN(object e)
    {
        ...
        LotteryLimitData data = (LotteryLimitData)e;
        tequip = data.tSythesis;
        _cost = data.cost;
    ...
    private void BackBtnHandle(GameObject go, object value1, object value2)
    {
        ...
        ccTimeEvent.GetInstance().f_UnRegEvent(Time_CreateRole);
        ccUIManage.GetInstance().f_SendMsg(UINameConst.GainCardLimitShowPage, UIMessageDef.UI_CLOSE);
    ...
    void UpdateCardUI()
    {
        ...
        {
            int AdCount = Data_Pool.m_BaseGoodsPool.f_GetHaveNumByTemplate(_cost.mResourceId);
            spriteName = UITool.f_GetMoneySpriteName((EM_MoneyType)_cost.mResourceId);
            num = (AdCount >= _cost.mResourceNum ? "[24ff00]" : "[ec2626]") + _cost.mResourceNum;
...
public class LotteryLimitData
{
    public EquipSythesis tSythesis;
    public ResourceCommonDT cost;
    
    public LotteryLimitData(EquipSythesis tSythesis, ResourceCommonDT cost)
    {
        this.tSythesis = tSythesis;
        this.cost = cost;
