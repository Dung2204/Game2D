...
/// 招募有礼活动
/// </summary>
public class NewYearRecruitGiftCtl : UIFramwork
{
    ...
    public void f_ShowView(ccUIBase actPage, int timeEnd)
    {
        ...
        //f_GetObject("SprTitleBg").GetComponent<UI2DSprite>().sprite2D = UITool.f_GetIconSprite(305);
    ...
    private void UpdateContent()
    {
        ...
        {
            _contentWrapComponet = new UIWrapComponent(206, 2, 654, 8, f_GetObject("GridContentParent"), f_GetObject("Item"), listContent, OnContentItemUpdate, null);
        }
