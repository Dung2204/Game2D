...
public class ChaosBattleRankItem : MonoBehaviour
{
    ...
    public void f_UpdateByInfo(bool isSelf, ChaosBattleRankPoolDT info)
    {
        int ret = info.Rank % 2;
        if (!isSelf)
            mBg.spriteName = ret != 0 ? "zr_pic_frame_a" : "zr_pic_frame_f";
