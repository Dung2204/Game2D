...
public class ArenaCrossRankPage : UIFramwork
{
    ...
    public UIWrapComponent mRankWrapComponet
    {
        get
        {
            ...
            {
                _arenaList = Data_Pool.m_CrossArenaPool.f_GetRankList();
    ...
    {
        AddGOReference("Panel/Anchor-Center/BG/Scroll View/ArenaRankItemParent");
        AddGOReference("Panel/Anchor-Center/AwardParent/SelfRankLabelTitel/SelfRankLabel");
        //AddGOReference("Panel/Anchor-Center/AwardParent/TargetRankLabelTitel/TargetRankLabel");
        AddGOReference("Panel/Anchor-Center/AwardParent/SelfAwardTitle/SelfAwardGrid");
        AddGOReference("Panel/Anchor-Center/AwardParent/TargetAwardTitle/TargetAwardGrid");
        AddGOReference("Panel/Anchor-Center/AwardParent/AwardNullLabel");
    ...
    protected override void UI_OPEN(object e)
    {
        ...
        mSelfRankLabel.text = Data_Pool.m_CrossArenaPool.m_iRank.ToString();
        ...
        //mTargetAwardShowComponent.f_Show(Data_Pool.m_CrossArenaPool.f_GetArenaRankAward(Data_Pool.m_ArenaPool.m_iTargetRank));
    }
    ...
    private void f_RankItemUpdateByInfo(Transform tf, BasePoolDT<long> dt)
    {
        ...
        item.f_UpdateByCrossInfo(dt);
    }

    private void f_CloseBtnHandle(GameObject go, object value1, object value2)
    {
        ccUIManage.GetInstance().f_SendMsg(UINameConst.ArenaCrossRankPage, UIMessageDef.UI_CLOSE);
    }
}