...
public class ShopEventTimeAwardSC : NBaseSC
{
    public ShopEventTimeAwardSC()
    {
        Create("ShopEventTimeAwardDT", true);
    }
    ...
    private void DispSaveData(string ppSQL)
    {
        ...
        for (int i = 0; i < tFoddScData.Length; i++)
        {
            try
            {
                ...
                int a = 0;
                DataDT = new ShopEventTimeAwardDT();
