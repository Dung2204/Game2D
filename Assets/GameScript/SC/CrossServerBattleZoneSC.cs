...
public class CrossServerBattleZoneSC : NBaseSC
{
    public CrossServerBattleZoneSC()
    {
        Create("CrossServerBattleZoneDT",true);
    }
    ...
    private void DispSaveData(string ppSQL)
    {
        ...
        CrossServerBattleZoneDT DataDT;
        string[] tData;
...
MessageBox.DEBUG(m_strRegDTName + "String with empty record, " + i);
                ...
                int a = 0;
                DataDT = new CrossServerBattleZoneDT();
