...
public class CrossServerBattleAwardSC : NBaseSC {
	public CrossServerBattleAwardSC() {
		Create("CrossServerBattleAwardDT", true);
	}
	...
	private void DispSaveData(string ppSQL) {
		...
		CrossServerBattleAwardDT DataDT;
...
MessageBox.DEBUG(m_strRegDTName + "String with empty record, " + i);
				...
				int a = 0;
				DataDT = new CrossServerBattleAwardDT();
