...
public class NewYearMultiRechargeAwardSC : NBaseSC
{
    public NewYearMultiRechargeAwardSC()
    {
        Create("NewYearMultiRechargeAwardDT", true);
    }
    ...
    private void DispSaveData(string ppSQL)
    {
        ...
        NewYearMultiRechargeAwardDT DataDT;
        string[] tData;
...
MessageBox.DEBUG(m_strRegDTName + "String with empty record, " + i);
                ...
                int a = 0;
                DataDT = new NewYearMultiRechargeAwardDT();
