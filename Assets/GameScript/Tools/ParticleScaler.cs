...
[ExecuteInEditMode]
[AddComponentMenu("Effects/ParticleScaler")]
public class ParticleScaler : MonoBehaviour
{
    public float particleScale = 1.0f;
    public bool alsoScaleGameobject = true;

    public int TrailRenderSortingOrder = 1;
    private bool TrailRenderSort = true;
    ...
    void ScaleLegacySystems(float scaleFactor)
    {
        ...
        {
            ParticleSystem.MainModule module = emitter.main;

            module.startSize = new ParticleSystem.MinMaxCurve(module.startSize.constantMin * scaleFactor, module.startSize.constantMax * scaleFactor);
            module.startSpeed = new ParticleSystem.MinMaxCurve(module.startSpeed.constantMin * scaleFactor, module.startSpeed.constantMax * scaleFactor);
    ...
    void ScaleTrailRenderers(float scaleFactor)
    {
        ...
        foreach (TrailRenderer trail in trails)
        {
            ...
            trail.sortingOrder = TrailRenderSortingOrder;
        }
        TrailRenderSort = false;
    }
}
