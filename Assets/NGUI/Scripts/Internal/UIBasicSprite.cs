...
#region Fill Functions
    ...
    void SimpleMirroredFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
    ...
    /// <param name="uvs"></param>
    /// <param name="cols"></param>
    void SimpleCrossMirrorFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        Vector4 v = drawingDimensions;
        Vector4 u = drawingUVs;
        Color32 c = drawingColor;
    ...
    /// <param name="uvs"></param>
    /// <param name="cols"></param>
    void SlicedMirrorFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
